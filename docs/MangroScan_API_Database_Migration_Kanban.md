...
| MEDIA-04 | GET /media/{id}Media metadata \+ authorized preview/download pointer. | Path: id | 200 {data:MediaAsset} | MEDIA-03 | **P0** | TBD \- Storage/API | **Ready** |
...
| JOB-02 | POST /processing-jobsQueue detector/classifier/combined processing. | {mission\_id,flight\_session\_id?,job\_type,media\_ids:\[uuid\],parameters?} | 202 {data:{processing\_job\_id,job\_status:"queued"}} | MEDIA-03 \+ AISVC-04 \+ MODEL-01 | **P0** | TBD \- AI/API | **Ready** |
