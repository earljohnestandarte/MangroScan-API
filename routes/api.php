...
Route::post('/flights/{flight}/battery-usage', BatteryUsageStoreController::class)
    ...
    Route::get('/media/{media}', MediaShowController::class)
        ->whereUuid('media')
        ->middleware([
            'auth:sanctum', EnsureActiveIdentity::class,
            'permission:media.read', 'throttle:auth.authenticated',
    ...
    Route::post('/sensor-datasets/uploads/{upload}/complete', SensorDatasetUploadCompleteController::class)
        ->whereUuid('upload')->middleware(['auth:sanctum', EnsureActiveIdentity::class, 'permission:media.upload', 'throttle:auth.authenticated']);
    ...
    Route::post('/mobile/sync', MobileSyncController::class)->middleware([
        'auth:sanctum',
        EnsureActiveIdentity::class,
        'throttle:auth.authenticated',
    ]);
